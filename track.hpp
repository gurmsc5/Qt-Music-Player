...
public:
  ...
  // TODO typedef ????? ConstIteratorType;
	...
	typedef std::list<MIDIEvent> Eventlist; //typedef for list of MIDIEvent
public:
...
private:
  ...
  // TODO
	intmax_t _ticks_per_beat_;
	Eventlist _eventlist; //MIDIevent list
	bool _on = false; // ON/OFF for note event bool
